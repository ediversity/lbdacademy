...
<?php if ($redux_demo['archive_excursions_header_img_display'] == 1){ ?>
	...
	<section id="nicdark_archive_parallax" class="nicdark_section nicdark_imgparallax" style="background:url(<?php echo $redux_demo['archive_excursions_header_img']['url']; ?>) 50% 0 fixed; background-size:cover;">
	    ...
	    <div class="nicdark_filter <?php echo $redux_demo['archive_excursions_header_filter']; ?>">
	        ...
	        <div class="nicdark_container nicdark_clearfix">
	            ...
	            <div class="grid grid_12">
	                ...
	                <h1 class="white subtitle"><?php echo $tax_name;  ?></h1><div class="nicdark_space10"></div><h3 class="subtitle white"><?php echo $term_name;  ?></h3>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_masonry_container">
			...
			while ( $the_query->have_posts() ) : $the_query->the_post();?>
				...
				<?php include 'archive-preview-excursion.php'; ?>
